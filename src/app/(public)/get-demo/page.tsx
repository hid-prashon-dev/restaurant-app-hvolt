  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center py-24 px-6">
      <div className="max-w-2xl w-full space-y-8 text-center">
        <h1 className="text-4xl md:text-5xl font-heading font-bold text-foreground">Request a Demo</h1>
        <p className="text-xl text-muted-foreground">
          See how Himavolt can unify your restaurant or hotel operations in real-time.
        </p>
